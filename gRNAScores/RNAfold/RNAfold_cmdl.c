...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[10] = RNAfold_args_info_detailed_help[12];
  RNAfold_args_info_full_help[11] = RNAfold_args_info_detailed_help[13];
  ...
  RNAfold_args_info_full_help[15] = RNAfold_args_info_detailed_help[20];
  RNAfold_args_info_full_help[16] = RNAfold_args_info_detailed_help[22];
  ...
  RNAfold_args_info_full_help[20] = RNAfold_args_info_detailed_help[27];
  RNAfold_args_info_full_help[21] = RNAfold_args_info_detailed_help[29];
  ...
  RNAfold_args_info_full_help[27] = RNAfold_args_info_detailed_help[38];
  RNAfold_args_info_full_help[28] = RNAfold_args_info_detailed_help[40];
  RNAfold_args_info_full_help[29] = RNAfold_args_info_detailed_help[41];
  RNAfold_args_info_full_help[30] = RNAfold_args_info_detailed_help[42];
  RNAfold_args_info_full_help[31] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_full_help[32] = RNAfold_args_info_detailed_help[46];
  RNAfold_args_info_full_help[33] = RNAfold_args_info_detailed_help[48];
  RNAfold_args_info_full_help[34] = RNAfold_args_info_detailed_help[49];
  RNAfold_args_info_full_help[35] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_full_help[36] = RNAfold_args_info_detailed_help[53];
  RNAfold_args_info_full_help[37] = RNAfold_args_info_detailed_help[54];
  RNAfold_args_info_full_help[38] = RNAfold_args_info_detailed_help[55];
  RNAfold_args_info_full_help[39] = RNAfold_args_info_detailed_help[56];
  RNAfold_args_info_full_help[40] = RNAfold_args_info_detailed_help[58];
  RNAfold_args_info_full_help[41] = RNAfold_args_info_detailed_help[60];
  RNAfold_args_info_full_help[42] = RNAfold_args_info_detailed_help[62];
  RNAfold_args_info_full_help[43] = RNAfold_args_info_detailed_help[63];
  RNAfold_args_info_full_help[44] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_full_help[45] = RNAfold_args_info_detailed_help[66];
  RNAfold_args_info_full_help[46] = RNAfold_args_info_detailed_help[68];
  RNAfold_args_info_full_help[47] = RNAfold_args_info_detailed_help[69];
  RNAfold_args_info_full_help[48] = RNAfold_args_info_detailed_help[71];
  RNAfold_args_info_full_help[49] = 0; 
  
}

const char *RNAfold_args_info_full_help[50];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[9] = RNAfold_args_info_detailed_help[12];
  RNAfold_args_info_help[10] = RNAfold_args_info_detailed_help[13];
  RNAfold_args_info_help[11] = RNAfold_args_info_detailed_help[14];
  RNAfold_args_info_help[12] = RNAfold_args_info_detailed_help[16];
  RNAfold_args_info_help[13] = RNAfold_args_info_detailed_help[22];
  ...
  RNAfold_args_info_help[18] = RNAfold_args_info_detailed_help[29];
  ...
  RNAfold_args_info_help[25] = RNAfold_args_info_detailed_help[42];
  RNAfold_args_info_help[26] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_help[27] = RNAfold_args_info_detailed_help[48];
  RNAfold_args_info_help[28] = RNAfold_args_info_detailed_help[53];
  RNAfold_args_info_help[29] = RNAfold_args_info_detailed_help[54];
  RNAfold_args_info_help[30] = RNAfold_args_info_detailed_help[55];
  RNAfold_args_info_help[31] = RNAfold_args_info_detailed_help[56];
  RNAfold_args_info_help[32] = RNAfold_args_info_detailed_help[58];
  RNAfold_args_info_help[33] = RNAfold_args_info_detailed_help[60];
  RNAfold_args_info_help[34] = RNAfold_args_info_detailed_help[62];
  RNAfold_args_info_help[35] = RNAfold_args_info_detailed_help[63];
  RNAfold_args_info_help[36] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_help[37] = RNAfold_args_info_detailed_help[71];
  RNAfold_args_info_help[38] = 0; 
  
}

const char *RNAfold_args_info_help[39];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->noPS_help = RNAfold_args_info_detailed_help[12] ;
  args_info->noconv_help = RNAfold_args_info_detailed_help[13] ;
  args_info->auto_id_help = RNAfold_args_info_detailed_help[14] ;
  args_info->id_prefix_help = RNAfold_args_info_detailed_help[16] ;
  args_info->id_digits_help = RNAfold_args_info_detailed_help[18] ;
  args_info->id_start_help = RNAfold_args_info_detailed_help[20] ;
  args_info->maxBPspan_help = RNAfold_args_info_detailed_help[24] ;
  args_info->constraint_help = RNAfold_args_info_detailed_help[25] ;
  args_info->batch_help = RNAfold_args_info_detailed_help[27] ;
  args_info->canonicalBPonly_help = RNAfold_args_info_detailed_help[29] ;
  args_info->enforceConstraint_help = RNAfold_args_info_detailed_help[30] ;
  args_info->shape_help = RNAfold_args_info_detailed_help[31] ;
  args_info->shapeMethod_help = RNAfold_args_info_detailed_help[32] ;
  args_info->shapeConversion_help = RNAfold_args_info_detailed_help[34] ;
  args_info->motif_help = RNAfold_args_info_detailed_help[36] ;
  args_info->commands_help = RNAfold_args_info_detailed_help[38] ;
  args_info->partfunc_help = RNAfold_args_info_detailed_help[42] ;
  args_info->MEA_help = RNAfold_args_info_detailed_help[44] ;
  args_info->pfScale_help = RNAfold_args_info_detailed_help[46] ;
  args_info->circ_help = RNAfold_args_info_detailed_help[48] ;
  args_info->ImFeelingLucky_help = RNAfold_args_info_detailed_help[49] ;
  args_info->bppmThreshold_help = RNAfold_args_info_detailed_help[51] ;
  args_info->gquad_help = RNAfold_args_info_detailed_help[53] ;
  args_info->temp_help = RNAfold_args_info_detailed_help[55] ;
  args_info->noTetra_help = RNAfold_args_info_detailed_help[56] ;
  args_info->dangles_help = RNAfold_args_info_detailed_help[58] ;
  args_info->noLP_help = RNAfold_args_info_detailed_help[60] ;
  args_info->noGU_help = RNAfold_args_info_detailed_help[62] ;
  args_info->noClosingGU_help = RNAfold_args_info_detailed_help[63] ;
  args_info->paramFile_help = RNAfold_args_info_detailed_help[64] ;
  args_info->nsp_help = RNAfold_args_info_detailed_help[66] ;
  args_info->energyModel_help = RNAfold_args_info_detailed_help[68] ;
  args_info->betaScale_help = RNAfold_args_info_detailed_help[69] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:o:t:C::p::S:cgT:4d:P:e:", long_options, &option_index);
