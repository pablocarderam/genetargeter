...
def get_mm_pam_scores_remote():
    try:
        mm_scores = pickle.load(open('./gRNAScores/CFD_Scoring/mismatch_score.pkl','rb'))
        pam_scores = pickle.load(open('./gRNAScores/CFD_Scoring/pam_scores.pkl','rb'))
...
if __name__ == '__main__':
    ...
    mm_scores,pam_scores = get_mm_pam_scores()
    wt = args.wt.upper()
    off = args.off.upper() # edited this
