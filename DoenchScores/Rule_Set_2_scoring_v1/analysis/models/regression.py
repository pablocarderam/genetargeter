...
#from DoenchScores.Rule_Set_2_scoring_v1.analysis.util import spearmanr_nonan
import scipy.stats as st
import DoenchScores.Rule_Set_2_scoring_v1.analysis.metrics as ranking_metrics
#import DoenchScores.Rule_Set_2_scoring_v1.analysis.predict
        ...
        for i, alpha in enumerate(learn_options["alpha"]):
            for j, l1r in enumerate(l1_ratio):
                ...
                if learn_options["training_metric"] == "AUC":
                    ...
                    spearman = spearmanr_nonan(y_all[learn_options['ground_truth_label']][train][test_inner], tmp_pred.flatten())[0]
